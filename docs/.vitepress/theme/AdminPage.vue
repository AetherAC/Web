...
import { Ban, BarChart3, Boxes, CreditCard, FileText, Github, GitBranch, KeyRound, LayoutDashboard, Plus, RefreshCw, Save, Settings, ShieldCheck, Trash2, UserX, Users } from 'lucide-vue-next'
