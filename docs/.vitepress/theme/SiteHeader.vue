...
import { Menu, X, ArrowUpRight, Headset, Mail, ShieldCheck } from 'lucide-vue-next'
...
<template>
  <header class="global-header">
    <nav class="nav-container" aria-label="主导航">
      ...
      <!--
        站内信在最右上角，一个信封。未读和待处理是两个数、两种颜色：待处理即使读过也还挡着（§9.6），
        加进未读里就等于读一遍之后没人再提醒它。
      -->
      <a v-if="auth.user.value" class="nav-inbox" href="/inbox" title="站内信" aria-label="站内信">
        <Mail :size="17" />
