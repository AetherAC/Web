...
('payerurl','PayerURL',array['PAYERURL_API_KEY','PAYERURL_SECRET','PAYERURL_WEBHOOK_SECRET'],'1. Create a PayerURL merchant/store. 2. Add merchant API and webhook secrets. 3. Configure create_url, create_headers and create_body or a hosted checkout_url_template. 4. Map checkout_url_path and provider_order_id_path. 5. Register /v1/callback/payerurl and complete a sandbox payment.',20),
